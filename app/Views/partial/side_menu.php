        ...
        <div class="sidebar-menu">
          <ul class="menu">
            ...
            <li class="sidebar-title">Data Barang</li>
                    ...
                    <li class="sidebar-item <?php if($uri->getSegment(1) == "barang"){echo "active";}?>">
                      <a href="<?=base_url('barang')?>" class='sidebar-link'>
                        <i class="fa-solid fa-box"></i>
                        <span>Data Barang</span>
                      </a>
                    </li>
                    <li class="sidebar-item <?php if($uri->getSegment(1) == "barang_masuk"){echo "active";}?>">
                      <a href="<?=base_url('barang_masuk')?>" class='sidebar-link'>
